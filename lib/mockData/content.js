...
But Anansi kept a little bit of wisdom for himself, which is why spiders are still clever, and why storytellers remember to share Anansi's tales, passing wisdom from one generation to the next.`,
  ...
  },
  {
    ...
    content: `Between the 11th and 15th centuries, Great Zimbabwe stood as one of Africa's most impressive civilizations. This magnificent stone city, whose name means "houses of stone" in the Shona language, was the capital of the Kingdom of Zimbabwe during the Late Iron Age.

The Great Enclosure, with its towering granite walls, housed the royal palace and was a symbol of the kingdom's power and sophistication. The city's strategic location allowed it to control the gold trade between the interior and the coast, making it one of the wealthiest settlements in medieval Africa.

Archaeological evidence reveals a complex society with advanced metallurgy, agriculture, and trade networks that extended across the Indian Ocean. The famous soapstone birds found at the site are believed to represent the spirits of past rulers, connecting the living with the ancestors.

The decline of Great Zimbabwe in the 15th century remains a subject of scholarly debate, with theories ranging from environmental degradation to political upheaval. However, its legacy lives on in the modern nation of Zimbabwe, which takes its name from this ancient wonder.

Today, Great Zimbabwe stands as a UNESCO World Heritage Site, reminding us of Africa's rich architectural and cultural heritage that predates European colonization by centuries.`,
  ...
  },
  {
    ...
    content: `Oral traditions in Africa are not merely stories told around a fire. They are sophisticated systems of knowledge preservation that have maintained the continent's history, values, and wisdom for thousands of years.

These living libraries exist in the memories of griots, praise singers, and storytellers who serve as the custodians of cultural heritage. Through carefully structured narratives, genealogies, and praise poems, they preserve everything from historical events to moral teachings.

The griot tradition of West Africa exemplifies this system perfectly. Griots are not just entertainers; they are historians, genealogists, and cultural ambassadors who can recite the lineages of noble families going back centuries. Their performances are both art and historical record.

In Southern Africa, praise singers perform similar functions, celebrating heroes and preserving the memory of great deeds. These traditions ensure that important cultural knowledge is not lost but continues to live and breathe in each generation.

Modern technology now offers new ways to preserve these oral traditions while maintaining their living, dynamic nature. Digital archives and audio recordings can complement, but never replace, the human connection that makes oral tradition so powerful.`,
    ...
    subscriptionTier: null,
    status: 'published',
    publishedAt: '2024-02-12T15:00:00.000Z',
    createdAt: '2024-02-12T00:00:00.000Z',
    updatedAt: '2024-02-12T15:00:00.000Z',
    likes: 234,
    views: 1123,
  ...
  {
    id: '8',
    title: 'The Kingdom of Kush: Nubian Pharaohs',
    type: 'article',
    author: 'Fatima Okafor',
    authorId: '4',
    description: 'The remarkable story of the Nubian pharaohs who ruled both Kush and Egypt, creating one of Africa\'s greatest empires.',
    content: `For nearly a century, from 747 to 656 BCE, pharaohs from the Kingdom of Kush ruled over both Nubia and Egypt, creating one of the most powerful empires in ancient Africa. These Nubian rulers, known as the "Black Pharaohs," brought stability and prosperity to the Nile Valley during a time of political chaos.

The Kingdom of Kush, centered in what is now Sudan, had been a major power for centuries before conquering Egypt. The Kushites had adopted many Egyptian customs while maintaining their own distinct culture, creating a unique blend of traditions that would influence the region for generations.

King Piye, the first of the Nubian pharaohs, conquered Egypt not through destruction but through diplomacy and strategic alliances. His successors, including Taharqa, would go on to build magnificent temples and monuments that rivaled those of their Egyptian predecessors.

The Kushite pharaohs were great patrons of art and architecture, commissioning beautiful temples at sites like Jebel Barkal and Nuri. They also revived many ancient Egyptian traditions that had been neglected, seeing themselves as the true inheritors of pharaonic culture.

Though their rule over Egypt eventually ended with the Assyrian invasion, the Kingdom of Kush continued to thrive for another thousand years, serving as a bridge between Africa and the Mediterranean world.`,
    coverImage: 'https://images.pexels.com/photos/4577735/pexels-photo-4577735.jpeg?auto=compress&cs=tinysrgb&w=800',
    tags: ['history', 'kush', 'nubia', 'pharaohs', 'egypt'],
    isFree: false,
    subscriptionTier: 'silver',
    status: 'published',
  ...
  {
    id: '9',
    title: 'The Tortoise and the Birds: A Yoruba Tale',
    type: 'story',
    author: 'Kwame Asante',
    authorId: '2',
    description: 'A traditional Yoruba folktale about wisdom, greed, and the consequences of our actions.',
    content: `Long ago, there was a great famine in the land. The animals had eaten all the food on earth, and they were growing thin and weak. But the birds had heard of a great feast in the sky, where there was plenty of food for everyone.

Tortoise, who was known for his cunning, heard about this feast and desperately wanted to attend. But he had no wings to fly to the sky. So he went to the birds and spoke to them with honeyed words.

"My dear friends," said Tortoise, "I have heard of your good fortune. Surely you would not leave your old friend to starve while you feast in the sky?"

The birds, being kind-hearted, agreed to help. Each bird gave Tortoise one feather, and soon he had enough to make a pair of wings. Together, they all flew up to the sky.

As they approached the feast, Tortoise spoke again: "My friends, it is customary at such gatherings for everyone to take a new name. I shall be called 'All of You.'"

When they arrived at the feast, the sky people welcomed them warmly. "This food is for all of you," they said, gesturing to the magnificent spread.

"You see?" said Tortoise to the birds. "They said the food is for 'All of You,' and that is my name!" And with that, he began to eat everything, leaving nothing for the birds.

The birds were furious at Tortoise's trickery. One by one, they took back their feathers and flew away, leaving Tortoise stranded in the sky with no way to get down.

Desperate, Tortoise called down to his wife: "Bring out all the soft things in our house and pile them up, for I must jump!"

But his wife, angry at his greed, brought out all the hard things instead - pots, stones, and iron tools. When Tortoise jumped, he crashed down hard, and his smooth shell was broken into many pieces.

That is why, to this day, the tortoise has a cracked shell, and why we say that greed and trickery will always come back to harm the one who practices them.`,
    coverImage: 'https://images.pexels.com/photos/6147366/pexels-photo-6147366.jpeg?auto=compress&cs=tinysrgb&w=800',
    tags: ['folklore', 'yoruba', 'nigeria', 'wisdom', 'morality'],
    isFree: true,
    subscriptionTier: null,
    status: 'published',
    publishedAt: '2024-02-16T14:00:00.000Z',
...
export const comments = [
  ...
  },
  {
    ...
    userAvatar: 'https://images.pexels.com/photos/1181519/pexels-photo-1181519.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop',
    comment: 'Ubuntu philosophy is so relevant today. This article beautifully explains how we can apply these ancient principles to modern challenges.',
    createdAt: '2024-02-02T16:20:00.000Z',
    likes: 23
  },
  {
    id: '5',
    ...
    userName: 'Amara Kone',
    userAvatar: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop',
    comment: 'I had no idea about the Nubian pharaohs! This completely changed my understanding of ancient African history.',
  ...
  },
  {
    ...
    userName: 'Fatima Okafor',
    userAvatar: 'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop',
    comment: 'My grandmother used to tell me this exact story! It brings back so many childhood memories. Thank you for preserving these tales.',
    createdAt: '2024-02-17T11:15:00.000Z',
    likes: 31
  }
];