      ...
      <article className="lg:col-span-8">
        ...
        <footer className="mt-12 pt-8 border-t" style={{ borderColor: 'var(--color-border)' }}>
          ...
          <div className="flex items-center justify-between mt-8">
            ...
            <Link href={`/creator/story/edit/${content.id}`} className="inline-flex items-center justify-center px-6 py-3 rounded-lg font-medium transition-colors" style={{ backgroundColor: 'var(--color-primary)', color: 'white' }}>
